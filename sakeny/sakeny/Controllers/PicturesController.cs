...
namespace sakeny.Controllers
{
    ...
    public class PicutresController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetPictures(int postId)
        {
            ...
            //var combinedImageData = Pictures.SelectMany(p => p.Picture).ToArray();

            // return File(combinedImageData, MediaTypeNames.Image.Jpeg, "images/jpg");

            return File(imageList.FirstOrDefault(), MediaTypeNames.Image.Jpeg);
