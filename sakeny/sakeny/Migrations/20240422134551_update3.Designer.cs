...
namespace sakeny.Migrations
{
    ...
    [Migration("20240422134551_update3")]
            ...
            modelBuilder.Entity("sakeny.Entities.PostFeaturesTbl", b =>
                {
                    ...
                    b.Property<decimal?>("PostsTblPostId")
                        .HasColumnType("numeric(18,0)");
            ...
            modelBuilder.Entity("sakeny.Entities.PostFeaturesTbl", b =>
                {
                    ...
                    b.HasOne("sakeny.Entities.PostsTbl", null)
                        .WithMany("PostFeaturesTbls")
                        .HasForeignKey("PostsTblPostId");
